...
int main()
{
    ...
    union longdouble_union ldb_min = {
        .bytes = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x01, 0x00, 0xd2, 0xc6, 0x50, 0xdb, 0x61, 0x59}};
    ...
    union longdouble_union ldb_max = {
        .bytes = {0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xfe, 0x7f, 0x21, 0x7a, 0x67, 0x55, 0x00, 0x00}};
