...
int main()
{
    ...
    printf("\tComputed: %d to %d\n", (int)(-1 * pow(2, size_of_char - 1)) , (int) (pow(2, size_of_char - 1) - 1));
    ...
    printf("\tPrinted: %d to %d\n", SHRT_MIN, SHRT_MAX);
    printf("\tComputed: %d to %d\n", (int)(-1 * pow(2, size_of_short_int - 1)), (int)(pow(2, size_of_short_int - 1) - 1));
    ...
    printf("\tPrinted: %d to %d\n", INT_MIN, INT_MAX);
    printf("\tComputed: %ld to %ld\n", (long int)(-1* pow(2, size_of_int-1)), (long int)(pow(2, size_of_int-1)-1));
    ...
    printf("\tComputed: %ld to %ld\n", (long int)(-1* pow(2, size_of_long_int-1)), (long int)(pow(2, size_of_long_int-1)-1));
    ...
    printf("\tComputed: %lld to %lld\n", (long long int)(-1* pow(2, size_of_long_long_int-1)), (long long int)(pow(2, size_of_long_long_int-1)-1));
    ...
    union longdouble_union ldb_min = {.bytes = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x01, 0x00, 0xd2, 0xc6, 0x50, 0xdb, 0x61, 0x59}};
    union longdouble_union ldb_true_min = {.bytes = {0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}};
    union longdouble_union ldb_max = {.bytes = {0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xfe, 0x7f, 0x21, 0x7a, 0x67, 0x55, 0x00, 0x00}};
